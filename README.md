...
| [`@seedcord/plugin-drizzle`](plugins/drizzle) | [![version](https://img.shields.io/npm/v/%40seedcord%2Fplugin-drizzle?style=flat-square&logo=npm&logoColor=c8341f&label=&labelColor=1f1f1f&color=c8341f)](plugins/drizzle/CHANGELOG.md) | any database through Drizzle ORM |
